...
using LearnPrgmApi.Models;

namespace LearnPrgmApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentDetailsController : ControllerBase
    {
        private readonly learnprgmContext _context;

        public StudentDetailsController(learnprgmContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<StudentDetail>> PostStudentDetail(StudentDetail studentDetail)
        {
          if (_context.StudentDetails == null)
          {
              return Problem("Entity set 'learnprgmContext.StudentDetails'  is null.");
          }
